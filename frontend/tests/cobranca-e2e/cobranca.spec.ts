...
test("executa acao, promessa e apropriacao idempotentes", async ({ page }, testInfo) => {
  ...
  await page.getByLabel("Pagamento oficial", { exact: true }).first().fill("00000000-0000-4000-8000-000000000082");
  await page.getByRole("button", { name: "Apropriacao idempotente" }).first().click();
