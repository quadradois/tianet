...
const SNAPSHOT_SHA256 = "f433314df34f67bcfa4766606f64d2ee1c8aed902c5243da6a73860077bff52a";
...
describe("contrato OpenAPI Comercial", () => {
  it("mantem inventario 107/135 e SHA governado", async () => {
    ...
    expect(Object.values(openapi.paths).flatMap((pathItem) => Object.keys(pathItem))).toHaveLength(128);
