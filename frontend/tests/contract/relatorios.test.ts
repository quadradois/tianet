...
describe("contrato OpenAPI de Relatorios", () => {
  it("preserva snapshot governado 107/135/SHA e os quatro GETs oficiais", () => {
    ...
    expect(snapshotHash).toBe("23d8d91f5f5890ef5ca010d1fc45a458458e5028042c80e7e15dbf82052af76a");
