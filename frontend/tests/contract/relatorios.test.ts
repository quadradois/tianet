...
describe("contrato OpenAPI de Relatorios", () => {
  it("preserva snapshot governado 111/137/SHA e os quatro GETs oficiais", () => {
    ...
    expect(snapshotHash).toBe("c8868afbf0645165da9795f718d91b8fba41bcc2bb8fa111578ec39bed58df0b");
