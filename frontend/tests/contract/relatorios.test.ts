...
describe("contrato OpenAPI de Relatorios", () => {
  it("preserva snapshot governado 107/133/SHA e os quatro GETs oficiais", () => {
    ...
    expect(snapshotHash).toBe("8dadf18eab0dad186044d71e832f72a5850661307d196187f2d0794b9d1d9ec1");
