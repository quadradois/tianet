...
function config(): BffConfig {
  return { backendUrl: "http://backend.configuracoes.invalid", origin: "http://frontend.configuracoes.invalid", production: false, currentKeyId: "current", currentKey: randomBytes(32) };
}
