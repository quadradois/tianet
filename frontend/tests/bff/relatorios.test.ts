...
function config(): BffConfig {
  return { backendUrl: "http://backend.relatorios.invalid", origin: "http://frontend.relatorios.invalid", production: false, currentKeyId: "current", currentKey: randomBytes(32) };
}
